...
window.addEventListener("load", function () {
     ...
     info.innerHTML =
          `
               <div class="flex_row hero-name">${heroInfo.name}</div>
               <div class="flex_row hero-img-and-more-info">
                    ...
                    <div class="flex_col more-info">
                         <div class="flex_row id">
                              <b>ID:</b><span>${heroInfo.id}</span>
                         </div>
                         <div class="flex_row comics">
                              <b>Comics:</b><span>${heroInfo.comics}</span>
                         </div>
                         <div class="flex_row series">
                              <b>Series:</b><span>${heroInfo.series}</span>
                         </div>
                         <div class="flex_row stories">
                              <b>Stories:</b><span>${heroInfo.stories}</span>
                         </div>
                    </div>
               </div>
               <div class="flex_col hero-discription">
                    <b>Discription:</b>
...
function addToFavourites() {
     ...
     if (this.innerHTML == '<i class="fa-solid fa-heart fav-icon"></i> &nbsp; Add to Favourites') {
          ...
          document.querySelector(".fav_toast").setAttribute("data-visiblity","show");
          // Deleting the "Added to Favourites" toast from DOM after 1 seconds
          setTimeout(function(){
               document.querySelector(".fav_toast").setAttribute("data-visiblity","hide");
          },1000);
     }
     // For removing the character form favourites array
          ...
          document.querySelector(".remove_toast").setAttribute("data-visiblity","show");
          // Deleting the "Remove from Favourites" toast from DOM after 1 seconds
          setTimeout(function(){
               document.querySelector(".remove_toast").setAttribute("data-visiblity","hide");
          },1000);
          // console.log();
     }     
}
...
let themeButton = document.getElementById("theme_btn");
